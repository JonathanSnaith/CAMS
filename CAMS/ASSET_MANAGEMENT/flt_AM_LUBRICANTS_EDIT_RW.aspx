<%@ Page Language="VB" AutoEventWireup="false" Title="Fleet Component Management - Lubricants - Edit" CodeFile="flt_AM_LUBRICANTS_EDIT_RW.aspx.vb" Inherits="ASSET_MANAGEMENT_flt_AM_LUBRICANTS_EDIT_RW" %>
        ...
        <div style="font-family: 'Arial Rounded MT Bold'; font-size: 18px; text-align: left; height: 100%;">
            ...
            <asp:SqlDataSource ID="SqlDS_PageCount" runat="server"
              ...
              <asp:SqlDataSource ID="SqlDS_Select" runat="server"
                ConnectionString="<%$ ConnectionStrings:CAMSConnectionString %>"
                SelectCommand="AM_LUBRICANTS_RG_SELECT_RW_SP"
                SelectCommandType="StoredProcedure">
                <SelectParameters>
                    <asp:ControlParameter ControlID="HF_LUB_ID" Name="LUB_ID" PropertyName="Value" />
                </SelectParameters>
            </asp:SqlDataSource>
            <asp:SqlDataSource ID="SqlDS_UPDATE" runat="server"
                ConnectionString="<%$ ConnectionStrings:CAMSConnectionString %>"
                SelectCommand="AM_LUBRICANTS_RG_UPDATE_SP"
                SelectCommandType="StoredProcedure">
                <SelectParameters>
                    <asp:ControlParameter ControlID="HF_LUB_ID" Name="LUB_ID" PropertyName="Value" Type="Int32" DefaultValue="0" />
                    ...
                    <asp:ControlParameter ControlID="RadCB_Status" Name="LUB_Status" PropertyName="SelectedValue" Type="String" DefaultValue="Submitted" />
