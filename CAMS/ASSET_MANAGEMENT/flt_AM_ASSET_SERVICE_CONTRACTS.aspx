<%@ Page Language="VB" AutoEventWireup="false" Title="CAMS Asset Management - Asset Service Contracts" CodeFile="flt_AM_ASSET_SERVICE_CONTRACTS.aspx.vb" Inherits="ASSET_MANAGEMENT_flt_AM_ASSET_SERVICE_CONTRACTS" %>
...
<script type="text/javascript">
    ...
    function RowSelected(sender, eventArgs) {
        var ATTid = sender.get_selectedItems()[0].getDataKeyValue('ASC_ID');
        document.getElementById('HF_ASC_ID').value = ATTid;
        //sessionStorage.setItem("ASC_ID", ATTid);
    }
    ...
    function fn_OnClickButton() {
        ...
        oWndadd.setUrl('flt_AM_ASSET_SERVICE_CONTRACTS_ADD_RW.aspx?FLT_GUID=' + THISGUID + '&PreviousPage=0', 'newwindow', 'target=_blank, top=50, left=200, height=350, width=750, status=no, menubar=no, resizable=no, location=no');
        oWndadd.show();
    }
    function fn_OnClickWindow() {
        var THISGUID = document.getElementById('lblGUID').innerHTML;
        var THISASC = document.getElementById('HF_ASC_ID').value;
        //var THISASC = sessionStorage.getItem("ASC_ID");
        var oWnd = $find("<%=RadWindow2.ClientID%>");
        oWnd.setUrl('flt_AM_ASSET_SERVICE_CONTRACTS_EDIT_RW.aspx?FLT_GUID=' + THISGUID + '&ASC_ID=' + THISASC + '&PreviousPage=0', 'newwindow', 'target=_blank, top=50, left=200, height=350, width=750, status=no, menubar=no, resizable=no, location=no');
        oWnd.show();
    }
    ...
    <form id="form1" runat="server">
        <div style="font-family: 'Arial Rounded MT Bold'; font-size: 18px; text-align: left; height: 100%;">
            ...
            <table class="style1" cellspacing="0" style="line-height: 50px">
                        <tr>
                            <td align="left" style="color: White; font-family: 'Segoe UI'; font-size: 20px; padding-left: 15px; background-color: #999999; text-align: center; font-weight: bold;" class="auto-style17">
                                 <asp:Label ID="lblTitle" runat="server" Text="ASSET SERVICE CONTRACTS" Font-Bold="False" ForeColor="White"></asp:Label>
                            </td>
                            ...
                            <td align="left" class="auto-style16" style="color: White; font-family: 'Segoe UI'; font-size: 16px; padding-left: 15px; background-color: #999999; text-align: left;">
                                <telerik:RadComboBox ID="RadCB_Site" runat="server" AllowCustomText="True" AutoPostBack="True" DataSourceID="SqlDS_CB_Site" DataTextField="Site_Name" DataValueField="SITE_ID" Filter="Contains" Font-Names="Segoe UI" Font-Size="10pt" ResolvedRenderMode="Classic">
                                </telerik:RadComboBox>
                            </td>
                            <td align="left" class="auto-style16" style="color: White; font-family: 'Segoe UI'; font-size: 16px; padding-left: 15px; background-color: #999999; text-align: right;">Asset: </td>
                                        ...
                                        <table border="0">
                                            <tr>
                                                <td class="metro_400x75_cell_content_top" colspan="2">
                                                    <img src="../IMAGES/Icons_Black/ASSET_SERVICE_CONTRACTS_NEW_NB.png" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="metro_400x75_cell_content_bottom_left">&#160;<asp:Label ID="Label34" runat="server" Text="NEW ASSET SERVICE CONTRACT" ForeColor="Black"></asp:Label>
                                                </td>
                                            </tr>
                                        </table>
                                    </asp:Panel>
                    ...
                    <table >
                        <tr>
                            <td class="style8" style="text-align: left; vertical-align: top;" colspan="2">
                                <asp:Label ID="lbl_Active_Contract_Text" runat="server" Font-Bold="True" Font-Size="16px" ForeColor="Black" Text="Active Service Contracts"></asp:Label>
                                </td>
                            <td class="style8" style="text-align: left; vertical-align: top;" colspan="2">
                                <asp:Label ID="lbl_Archive_Contract_Text" runat="server" Font-Bold="True" Font-Size="16px" ForeColor="Black" Text="Archive Service Contracts"></asp:Label>
                                </td>
                            </tr>
                        <tr>
                            <td class="style8" style="text-align: left; vertical-align: top;" colspan="2">
                               <telerik:RadGrid ID="RadGrid_Asset_Contract" runat="server" AllowAutomaticInserts="True" AllowAutomaticUpdates="True" AllowSorting="True"
                                    DataSourceID="SqlDS_RadGrid_SP_ASSET_CONTRACT" ResolvedRenderMode="Classic" Skin="Default" RegisterWithScriptManager="True">
                                    ...
                                    <MasterTableView AutoGenerateColumns="False" ClientDataKeyNames="ASC_ID" DataKeyNames="ASC_ID" DataSourceID="SqlDS_RadGrid_SP_ASSET_CONTRACT">
                                        ...
                                        <Columns>
                                            <telerik:GridBoundColumn DataField="ASC_ID" DataType="System.Int32"
                                                Display="False" FilterControlAltText="Filter ASC_ID column" HeaderText="ID"
                                                ReadOnly="True" SortExpression="ASC_ID" UniqueName="ASC_ID">
                                            ...
                                            <telerik:GridBoundColumn DataField="Model" Display="True"
                                             ...
                                             <telerik:GridBoundColumn DataField="ASC_Type"
                                                FilterControlAltText="Filter ASC_Type column" HeaderText="Contract Type"
                                                ReadOnly="True" SortExpression="ASC_Type" UniqueName="ASC_Type">
                                                <HeaderStyle Width="100px" Wrap="False" />
                                                <ItemStyle Width="100px" Wrap="True" />
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="ASC_Months"
                                                FilterControlAltText="Filter ASC_Months column" HeaderText="Months"
                                                ReadOnly="True" SortExpression="ASC_Months" UniqueName="ASC_Months">
                                                <HeaderStyle Width="60px" Wrap="False" />
                                                <ItemStyle Width="60px" Wrap="True" />
                                            </telerik:GridBoundColumn>
                                             <telerik:GridBoundColumn DataField="ASC_Agreed_Usage"
                                                FilterControlAltText="Filter ASC_Agreed_Usage column" HeaderText="Agreed Usage"
                                                ReadOnly="True" SortExpression="ASC_Agreed_Usage" UniqueName="ASC_Agreed_Usage">
                                                <HeaderStyle Width="100px" Wrap="False" />
                                                <ItemStyle Width="100px" Wrap="True" />
                                            </telerik:GridBoundColumn>
                                             <telerik:GridBoundColumn DataField="ASC_Month_Cost" DataFormatString="{0:£#,##0.00}"
                                                FilterControlAltText="Filter ASC_Month_Cost column" HeaderText="Rate"
                                                ReadOnly="True" SortExpression="ASC_Month_Cost" UniqueName="ASC_Month_Cost">
                                                <HeaderStyle Width="100px" Wrap="False" />
                                                <ItemStyle Width="100px" Wrap="True" />
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="ASC_Start_Date"
                                                DataFormatString="{0:dd MMM yyyy}"
                                                FilterControlAltText="Filter ASC_Start_Date column" HeaderText="Start Date"
                                                ReadOnly="True" SortExpression="ASC_Start_Date" UniqueName="ASC_Start_Date">
                                                <HeaderStyle Width="100px" Wrap="False" />
                                                <ItemStyle Width="100px" Wrap="False" />
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="ASC_End_Date"
                                                DataFormatString="{0:dd MMM yyyy}"
                                                FilterControlAltText="Filter ASC_End_Date column" HeaderText="End Date"
                                                ReadOnly="True" SortExpression="ASC_End_Date" UniqueName="ASC_End_Date">
                                                <HeaderStyle Width="100px" Wrap="False" />
                                                <ItemStyle Width="100px" Wrap="False" />
                                            </telerik:GridBoundColumn>
                                             <telerik:GridBoundColumn DataField="ASC_End_Hours"
                                                FilterControlAltText="Filter ASC_End_Hours column" HeaderText="Contract Length (Hrs)"
                                                ReadOnly="True" SortExpression="ASC_End_Hours" UniqueName="ASC_End_Hours">
                                                <HeaderStyle Width="60px" Wrap="False" />
                                                <ItemStyle Width="60px" Wrap="True" />
                                            </telerik:GridBoundColumn>
                                             <telerik:GridBoundColumn DataField="Company"
                                                FilterControlAltText="Filter Company column" HeaderText="Supplier"
                                                ReadOnly="True" SortExpression="Company" UniqueName="Company">
                                                <HeaderStyle Width="100px" Wrap="False" />
                                                <ItemStyle Width="100px" Wrap="True" />
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="ASC_Status"
                                                FilterControlAltText="Filter ASC_Status column" HeaderText="Status"
                                                ReadOnly="True" SortExpression="ASC_Status" UniqueName="ASC_Status">
                                                <HeaderStyle Width="100px" Wrap="False" />
                                                <ItemStyle Width="100px" Wrap="True" />
                                            </telerik:GridBoundColumn>
                                        </Columns>
                            ...
                            <td class="style5" style="text-align: left" valign="top">
                                 <telerik:RadGrid ID="RadGrid_Asset_Contract_Archive" runat="server" AllowAutomaticInserts="True" AllowAutomaticUpdates="True" AllowSorting="True"
                                    DataSourceID="SqlDS_RadGrid_SP_ASSET_CONTRACT_ARCHIVE" ResolvedRenderMode="Classic" Skin="Default" RegisterWithScriptManager="True">
                                    <ClientSettings EnableAlternatingItems="True">
                                        <Selecting AllowRowSelect="True" />
                                        <ClientEvents OnRowDblClick="fn_onrowdblclick" OnRowSelected="RowSelected" />
                                        <Resizing AllowResizeToFit="True" ResizeGridOnColumnResize="True" />
                                    </ClientSettings>
                                    <MasterTableView AutoGenerateColumns="False" ClientDataKeyNames="ASC_ID" DataKeyNames="ASC_ID" DataSourceID="SqlDS_RadGrid_SP_ASSET_CONTRACT_ARCHIVE">
                                        <RowIndicatorColumn Visible="False">
                                        </RowIndicatorColumn>
                                        <ExpandCollapseColumn Created="True">
                                        </ExpandCollapseColumn>
                                        ...
                                        <Columns>
                                            ...
                                            <telerik:GridBoundColumn DataField="ASC_Status" Display="False"
                                                FilterControlAltText="Filter ASC_Status column" HeaderText="Status"
                                                ReadOnly="True" SortExpression="ASC_Status" UniqueName="ASC_Status">
                                                <HeaderStyle Width="100px" Wrap="False" />
                                                <ItemStyle Width="100px" Wrap="True" />
                                            ...
                                            <telerik:GridBoundColumn DataField="ThisCount" Display="False"
                                                FilterControlAltText="Filter ThisCount column" HeaderText="Active Contracts"
            ...
            <asp:SqlDataSource ID="SqlDS_CB_Asset" runat="server"
                ConnectionString="<%$ ConnectionStrings:CAMSConnectionString %>"
                SelectCommand="SELECT '%' AS A_ID, '*All Assets' AS A_Asset_ID UNION ALL SELECT DISTINCT CONVERT (nvarchar(5), ASSET.A_ID) AS A_ID, ASSET.A_Asset_ID FROM ASSET INNER JOIN ASSET_SERVICE_CONTRACTS ON ASSET_SERVICE_CONTRACTS.ASC_A_ID = ASSET.A_ID WHERE (ASSET.A_Status NOT IN ('Trash', 'Delete')) AND (CONVERT (nvarchar(5), ASSET.A_SITE_ID) LIKE @Site) ORDER BY A_Asset_ID">
                <SelectParameters>
            ...
            <asp:SqlDataSource ID="SqlDS_RadGrid_SP_ASSET_CONTRACT" runat="server"
                ConnectionString="<%$ ConnectionStrings:CAMSConnectionString %>"
                SelectCommand="AM_ASSET_SC_RG_SELECT_SP"
              ...
              <asp:SqlDataSource ID="SqlDS_RadGrid_SP_ASSET_CONTRACT_ARCHIVE" runat="server"
                ConnectionString="<%$ ConnectionStrings:CAMSConnectionString %>"
                SelectCommand="AM_ASSET_SC_ARCHIVE_RG_SELECT_SP"
                SelectCommandType="StoredProcedure">
                <SelectParameters>
                    <asp:ControlParameter ControlID="RadCB_Site" Name="A_SITE_ID" PropertyName="SelectedValue" Type="String" />
                    <asp:ControlParameter ControlID="RadCB_Asset" Name="A_ID" PropertyName="SelectedValue" Type="String" />
            ...
            <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server" DefaultLoadingPanelID="RadAjaxLoadingPanel1" RequestQueueSize="1">
                <AjaxSettings>
                    <telerik:AjaxSetting AjaxControlID="RadWindow1">
                        <UpdatedControls>
                            <telerik:AjaxUpdatedControl ControlID="RadGrid_Asset_Contract" />
                             <telerik:AjaxUpdatedControl ControlID="RadGrid_Asset_Contract_Archive" />
                        </UpdatedControls>
                    </telerik:AjaxSetting>
            ...
            <telerik:RadWindow ID="RadWindow1" runat="server" Height="400px" Width="700px" OnClientClose="closeWindow_add_event_new_item" Behaviors="Close, Move" Modal="True" Title="New Asset Service Contract" VisibleStatusbar="False" KeepInScreenBounds="True">
            </telerik:RadWindow>
            <telerik:RadWindow ID="RadWindow2" runat="server" Height="450px" Width="1400px" OnClientClose="closeWindow_add_event" Behaviors="Close, Move" Modal="True" Title="Edit Asset Service Contract" VisibleStatusbar="False" KeepInScreenBounds="True" ShowContentDuringLoad="False">
            </telerik:RadWindow>
        </div>
    </form>
</body>
