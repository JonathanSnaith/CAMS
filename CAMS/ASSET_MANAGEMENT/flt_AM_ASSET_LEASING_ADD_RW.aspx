<%@ Page Language="VB" AutoEventWireup="false" Title="CAMS Asset Management - Asset Leasing - Add Lease" CodeFile="flt_AM_ASSET_LEASING_ADD_RW.aspx.vb" Inherits="ASSET_MANAGEMENT_flt_AM_ASSET_LEASING_ADD_RW" %>
    ...
    <form id="form1" runat="server">
        <div style="font-family: 'Arial Rounded MT Bold'; font-size: 18px; text-align: left; height: 100%;">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <telerik:RadComboBox ID="RadCB_Asset" runat="server"
                                            ...
                                            ResolvedRenderMode="Classic" Skin="Glow" AllowCustomText="True"
                                ...
                                <tr>
                                    ...
                                    <td style="padding-left: 60px">
                                        <telerik:RadButton ID="Btn_Save" runat="server"
                                            Skin="Glow" Text="Save" Width="100px" BackColor="Red">
                                        </telerik:RadButton>
                                    </td>
                                </tr>
                                <tr>
            ...
            <asp:SqlDataSource ID="SqlDS_Insert" runat="server"
                ConnectionString="<%$ ConnectionStrings:CAMSConnectionString %>"
                SelectCommand="AM_ASSET_LEASING_RG_INSERT_SP"
                SelectCommandType="StoredProcedure">
                <SelectParameters>
                    <asp:ControlParameter ControlID="RadCB_Asset" Name="AL_A_ID" PropertyName="SelectedValue" Type="Int32" DefaultValue="0" />
                    ...
                    <asp:ControlParameter ControlID="lblWhoIsIt" Name="AL_Created_By" PropertyName="Text" Type="String" DefaultValue="0" />
            ...
            <asp:SqlDataSource ID="SqlDS_CB_Asset" runat="server"
                ConnectionString="<%$ ConnectionStrings:CAMSConnectionString %>"
                SelectCommand="SELECT 0 AS A_ID, '*Not Specified' AS A_Asset_ID UNION ALL SELECT DISTINCT A_ID, A_Asset_ID FROM ASSET WHERE (A_Status NOT IN ('Trash', 'Delete')) AND (A_ID NOT IN (SELECT AL_A_ID FROM ASSET_LEASING WHERE (AL_Status = 'Active'))) AND (A_ID NOT IN ('1785', '1803', '1888', '1889', '1749', '1750', '1758', '1759', '1751', '1752', '1747', '1748', '1374', '1828', '1829', '1355')) ORDER BY A_Asset_ID"></asp:SqlDataSource>
