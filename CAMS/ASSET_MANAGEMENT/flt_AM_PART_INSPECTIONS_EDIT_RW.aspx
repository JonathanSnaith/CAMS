<%@ Page Language="VB" AutoEventWireup="false" Title="FLEET - Part Inspection Edit" CodeFile="flt_AM_PART_INSPECTIONS_EDIT_RW.aspx.vb" Inherits="AM_PART_INSPECTIONS_EDIT_RW" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <div style="font-family: 'Arial Rounded MT Bold'; font-size: 18px; text-align: left; height: 100%;">
                ...
                <telerik:RadPane ID="RadPane2" runat="server" BorderStyle="None" Scrolling="Both" Style="text-align: right" Font-Names="Segoe UI" ForeColor="White">
                    <table cellspacing="0" style="width: 100%">
                        <tr>
                            ...
                            <td align="left" style="color: #FFFFFF; font-family: 'Segoe UI'; font-size: 16px; font-weight: bold; padding-left: 15px; height: 45px; background-color: #E46C0A;">
                                NEW PART INSPECTION
                    ...
                    <telerik:RadMultiPage ID="RadMultiPage1" runat="server">
                        <telerik:RadPageView ID="RadPV_GENERAL" runat="server" Selected="True">
                            <table class="style_table_general">
                                ...
                                <tr>
                                    <td class="auto-style3" style="padding-right: 20px">Status:</td>
                                    <td colspan="2">
                                        <telerik:RadComboBox ID="RadCB_Status" runat="server">
                                            <Items>
                                                <telerik:RadComboBoxItem runat="server" Selected="True" Text="Active" Value="Active" />
            ...
            <asp:SqlDataSource ID="SqlDS_GetInspectionData" runat="server"
                ConnectionString="<%$ ConnectionStrings:CAMSConnectionString %>"
                SelectCommand="AM_PART_INSPECTIONS_RG_SELECT_RW_SP" SelectCommandType="StoredProcedure">
                <SelectParameters>
                    <asp:ControlParameter ControlID="HF_PDI_ID" Name="PDI_ID" PropertyName="Value" Type="String" />
                </SelectParameters>
            </asp:SqlDataSource>
            <asp:SqlDataSource ID="SqlDS_GetNext" runat="server"
                ConnectionString="<%$ ConnectionStrings:CAMSConnectionString %>"
                SelectCommand="AM_PART_INSPECTIONS_RG_SELECT_RW_SP" SelectCommandType="StoredProcedure">
                <SelectParameters>
                    <asp:ControlParameter ControlID="HF_PDI_ID" Name="PDI_ID" PropertyName="Value" Type="String" />
            ...
            <asp:SqlDataSource ID="SqlDS_Update" runat="server"
                ConnectionString="<%$ ConnectionStrings:CAMSConnectionString %>"
                SelectCommand="AM_PART_INSPECTIONS_RG_UPDATE_SP"
                SelectCommandType="StoredProcedure">
                <SelectParameters>
                    <asp:ControlParameter ControlID="HF_PDI_ID" Name="PDI_ID" PropertyName="Value" Type="String" DefaultValue="0" />
                    ...
                    <asp:ControlParameter ControlID="RadCB_Status" Name="PDI_Status" PropertyName="SelectedValue" Type="String" DefaultValue="Active" />
                    <asp:ControlParameter ControlID="RadTxt_Comments" Name="PDI_Comments" PropertyName="Text" Type="String" DefaultValue="abc" />
                    <asp:ControlParameter ControlID="lblWhoIsIt" Name="PDI_Modified_By" PropertyName="Text" Type="String" DefaultValue="0" />
                </SelectParameters>
            </asp:SqlDataSource>
