...
Partial Class ASSET_MANAGEMENT_flt_AM_ENGINE_LOAD_FACTORS
    ...
    Protected Sub Page_Init(sender As Object, e As System.EventArgs) Handles Me.Init
        ...
        Me.RadGrid_Engine_Load_Factors.Visible = True
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        If Me.lblRun.Text = "" Then
            Me.lblRun.Text = "1"
            lblPageName.Text = "AM - Engine Load Factors"
            ...
            Else
                ...
                Else
                    ...
                    Select Case eventTarget
                        ...
                        Case "Refresh_Grid"
                            Dim valuepassed As String = eventArgument
                            Me.RadGrid_Engine_Load_Factors.Rebind()
                            WhichRowSelected()
                            SelectCorrectRecord()
                        Case Else
                    End Select
    ...
    Sub WhichRowSelected()
        ...
        For Each item As Telerik.Web.UI.GridDataItem In RadGrid_Engine_Load_Factors.Items
            Dim intCategoryID As Integer = Convert.ToInt32(item("ELF_ID").Text)
            count = count + 1
    ...
    Sub SelectCorrectRecord()
        Dim count As Integer = 0
        For Each item As Telerik.Web.UI.GridDataItem In RadGrid_Engine_Load_Factors.Items
            Dim EventIDCell As TableCell = item("ELF_ID")
            Dim EventID = EventIDCell.Text
            count = count + 1
            If Session("ELF_ID") = "null" Then Session("ELF_ID") = "0"

            If Session("ELF_ID") = EventID Then
                item.Selected = True
            End If
        Next
    End Sub
    Protected Sub RadCB_Model_SelectedIndexChanged(sender As Object, e As Telerik.Web.UI.RadComboBoxSelectedIndexChangedEventArgs) Handles RadCB_Model.SelectedIndexChanged
        ...
        Me.RadGrid_Engine_Load_Factors.Visible = True
        Me.RadGrid_Engine_Load_Factors.DataBind()
    End Sub
