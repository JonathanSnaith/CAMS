...
Partial Class ASSET_MANAGEMENT_flt_AM_ASSET_LEASING
    ...
    Protected Sub Page_Init(sender As Object, e As System.EventArgs) Handles Me.Init
        ...
        Me.RadGrid_Asset_Leasing.Visible = True
        Me.RadGrid_Asset_Leasing_Archive.Visible = True
                            ...
                            Case 1 ' APPLICATION EXCEPTIONS
                                Select Case dr("EXCEPTION_ID").ToString()
                                    ...
                                    Case 155
                                        If dr("Value") = Nothing Then
                                        Else
                                            Me.HF_EXCEPTION_18_RW.Value = 1 'Financial - RW
                                        End If
                                End Select
                            Case Else
                        End Select
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        If Me.lblRun.Text = "" Then
            Me.lblRun.Text = "1"
            lblPageName.Text = "AM - Asset Leasing"
            ...
            Else
                ...
                Else
                    ...
                    Select Case eventTarget
                        ...
                        Case "Refresh_Grid"
                            Dim valuepassed As String = eventArgument
                            Me.RadGrid_Asset_Leasing.Rebind()
                            Me.RadGrid_Asset_Leasing_Archive.Rebind()
                            WhichRowSelected()
                            SelectCorrectRecord()
                        Case Else
                    End Select
    ...
    Sub WhichRowSelected()
        ...
        For Each item As Telerik.Web.UI.GridDataItem In RadGrid_Asset_Leasing.Items
            Dim intCategoryID As Integer = Convert.ToInt32(item("AL_ID").Text)
            count = count + 1
    ...
    Sub SelectCorrectRecord()
        Dim count As Integer = 0
        For Each item As Telerik.Web.UI.GridDataItem In RadGrid_Asset_Leasing.Items
            Dim EventIDCell As TableCell = item("AL_ID")
            Dim EventID = EventIDCell.Text
            count = count + 1
            If Session("AL_ID") = "null" Then Session("AL_ID") = "0"

            If Session("AL_ID") = EventID Then
                item.Selected = True
            End If
        Next
    End Sub
    Protected Sub RadCB_Site_SelectedIndexChanged(sender As Object, e As Telerik.Web.UI.RadComboBoxSelectedIndexChangedEventArgs) Handles RadCB_Site.SelectedIndexChanged
        Me.RadGrid_Asset_Leasing.Visible = True
        Me.RadGrid_Asset_Leasing_Archive.Visible = True
        Me.RadGrid_Asset_Leasing.DataBind()
        Me.RadGrid_Asset_Leasing_Archive.DataBind()
        Me.RadCB_Asset.SelectedValue = "%"
        Me.RadCB_Model.SelectedValue = "%"
    End Sub
    ...
    Protected Sub btn_Refresh_Click(sender As Object, e As EventArgs) Handles btn_Refresh.Click
        ...
        Me.RadGrid_Asset_Leasing_Archive.Rebind()
    End Sub
    Protected Sub RadGrid_Asset_Leasing_ItemDataBound(ByVal sender As Object, ByVal e As Telerik.Web.UI.GridItemEventArgs) Handles RadGrid_Asset_Leasing.ItemDataBound
        For Each item As GridDataItem In RadGrid_Asset_Leasing.Items
            Dim myTotalCell4 As TableCell = item("AL_Status")
        ...
        Next
    End Sub
    Protected Sub RadGrid_Asset_Leasing_Archive_ItemDataBound(ByVal sender As Object, ByVal e As Telerik.Web.UI.GridItemEventArgs) Handles RadGrid_Asset_Leasing_Archive.ItemDataBound
        For Each item As GridDataItem In RadGrid_Asset_Leasing_Archive.Items
            Dim myTotalCell4 As TableCell = item("AL_Status")
            Dim ActiveLeases As TableCell = item("ThisCount")
            If InStr(myTotalCell4.Text, "&nbsp;") Then
            Else
                Dim ThisTotal4 = myTotalCell4.Text
                Dim ActiveLeasesText = ActiveLeases.Text
                If ThisTotal4 = "Expired" And ActiveLeasesText = "0" Then
