...
Partial Class ASSET_MANAGEMENT_flt_AM_ASSET_LEASING_ADD_RW
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        If Me.lblRun.Text = "" Then
            Me.lblRun.Text = "1"
            lblPageName.Text = "AM - Asset Leasing - Add"
    ...
    Protected Sub Btn_Save_Click(sender As Object, e As System.EventArgs) Handles Btn_Save.Click
        ...
        SqlDS_Insert.SelectParameters("AL_A_ID").DefaultValue = 0
        SqlDS_Insert.SelectParameters("AL_COM_ID").DefaultValue = 0
        SqlDS_Insert.SelectParameters("AL_Start_Date").DefaultValue = "1900-01-01"
        SqlDS_Insert.SelectParameters("AL_End_Date").DefaultValue = "1900-01-01"
        SqlDS_Insert.SelectParameters("AL_Status").DefaultValue = "Active"
        SqlDS_Insert.SelectParameters("AL_Created_By").DefaultValue = Me.lblWhoIsIt.Text
        SqlDS_Insert.SelectParameters("AL_Modified_By").DefaultValue = Me.lblWhoIsIt.Text
