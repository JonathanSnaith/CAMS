...
Partial Class ASSET_MANAGEMENT_flt_AM_LUBRICANTS_EDIT_RW
    Inherits System.Web.UI.Page
    Protected Sub Page_Init(sender As Object, e As System.EventArgs) Handles Me.Init
        Response.Cache.SetCacheability(System.Web.HttpCacheability.NoCache)
        Me.HF_LUB_ID.Value = Request.QueryString("LUB_ID")
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        If Me.lblRun.Text = "" Then
            Me.lblRun.Text = "1"
            lblPageName.Text = "AM - Lubricants - Edit"
    ...
    Sub GetData()
        ...
        For Each drvSql As DataRowView In dvSql
            Me.RadCB_Company.SelectedValue = drvSql("LUB_COM_ID").ToString()
            Me.RadCB_Model.SelectedValue = drvSql("LUB_MOD_ID").ToString()
            Me.RadCB_Compartment.SelectedValue = drvSql("LUB_CP_ID").ToString()
            Me.RadCB_Type.SelectedValue = drvSql("LUB_Type_ID").ToString()
            Me.RadCB_Status.SelectedValue = drvSql("LUB_Status").ToString()
        Next
    End Sub
