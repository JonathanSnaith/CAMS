<%@ Page Language="VB" AutoEventWireup="false" Title="CAMS Event Management - Archive Events" CodeFile="flt_EM_ARCHIVE_EVENTS.aspx.vb" Inherits="EVENT_MANAGEMENT_flt_EM_ARCHIVE_EVENTS" %>
            ...
            <telerik:RadSplitter ID="RadSplitter1" runat="server" Width="100%" Height="100%" BorderSize="0" BorderStyle="None" LiveResize="True">
                <telerik:RadPane ID="RadPane2" runat="server" BorderStyle="None" Scrolling="Both" Style="text-align: right" Font-Names="Segoe UI" ForeColor="White">
                    <table class="style1" cellspacing="0">
                        <tr>
                            ...
                            <td align="center" style="color: White; font-family: 'Segoe UI'; font-size: 14px; font-weight: bold; padding-left: 15px; background-color: #ff661c; text-align: left;" valign="middle">
                                <telerik:RadButton ID="RadBtn_EXPORT" runat="server" AutoPostBack="True" Font-Names="Segoe UI" Font-Size="10pt" Skin="Glow" Text="Export">
                                </telerik:RadButton>
                            </td>
                        </tr>
                    </table>
                    <table class="style1" cellspacing="0" style="line-height: 50px;">
                        <tr>
                            <td align="left" style="color: White; font-family: 'Segoe UI'; font-size: 20px; padding-left: 15px; background-color: #42C1FF; text-align: center; font-weight: bold;" class="auto-style27" rowspan="2">
                                <asp:Label ID="lblTitle" runat="server" Text="ARCHIVE EVENTS" Font-Bold="False" ForeColor="White"></asp:Label>
                            </td>
                            <td align="left" style="color: White; font-family: 'Segoe UI'; font-size: 16px; padding-left: 15px; background-color: #42C1FF; text-align: right;" rowspan="2">
                                <telerik:RadButton ID="btn_Refresh" runat="server" Text="Refresh" Width="100px" Skin="Glow">
                                </telerik:RadButton>
                            </td>
                            <td align="left" style="color: White; font-family: 'Segoe UI'; font-size: 16px; padding-left: 15px; background-color: #42C1FF; text-align: right;">
                            ...
                            <td align="left" style="color: White; font-family: 'Segoe UI'; font-size: 16px; padding-left: 15px; background-color: #42C1FF; text-align: right; padding-top: 5px;">
                            ...
                            <td align="left" style="color: White; font-family: 'Segoe UI'; font-size: 16px; padding-left: 15px; background-color: #42C1FF; text-align: left; padding-top: 5px;">
                                <telerik:RadComboBox ID="RadCB_EventType" runat="server" AllowCustomText="True" AutoPostBack="True"  DataTextField="ATT_Name" DataValueField="ATT_ID" Filter="Contains" Font-Names="Segoe UI" Font-Size="10pt" ResolvedRenderMode="Classic" Skin="Glow" Width="250px">
                                </telerik:RadComboBox>
                            </td>
                            <td align="left" style="color: White; font-family: 'Segoe UI'; font-size: 16px; padding-left: 15px; background-color: #42C1FF; text-align: right; padding-top: 5px;">
                            ...
                            <td align="left" style="color: White; font-family: 'Segoe UI'; font-size: 16px; padding-left: 15px; background-color: #42C1FF; text-align: left; padding-top: 5px;">
                                <telerik:RadTextBox ID="RadTxt_Instruction" runat="server" AutoPostBack="True" EmptyMessage="search any text field" LabelWidth="100px" Resize="None" Skin="Glow" Width="250px">
                                </telerik:RadTextBox>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td align="left" style="color: White; font-family: 'Segoe UI'; font-size: 16px; padding-left: 15px; background-color: #42C1FF; text-align: right;">Date Created (From) </td>
                            <td align="left" style="color: White; font-family: 'Segoe UI'; font-size: 16px; padding-left: 15px; background-color: #42C1FF; text-align: left;">
                            ...
                            <td align="left" style="color: White; font-family: 'Segoe UI'; font-size: 16px; padding-left: 15px; background-color: #42C1FF; text-align: right;">Date Created (To) </td>
                            <td align="left" style="color: White; font-family: 'Segoe UI'; font-size: 16px; padding-left: 15px; background-color: #42C1FF; text-align: left;">
                            ...
                            <td colspan="7" style="text-align: left; vertical-align: top;">
                                <telerik:RadGrid ID="RadGrid_Archive_Events" runat="server" AllowAutomaticInserts="True" AllowAutomaticUpdates="True"
                                    ...
                                    <MasterTableView AutoGenerateColumns="False" ClientDataKeyNames="E_ID" DataKeyNames="E_ID"
                                        ...
                                        <CommandItemSettings AddNewRecordText="Add new event" ShowAddNewRecordButton="False" ShowRefreshButton="False" />
                                        <Columns>
                                            ...
                                            <telerik:GridBoundColumn DataField="EventType"
                                                FilterControlAltText="Filter EventType column" HeaderText="Type"
                                            ...
                                            <telerik:GridBoundColumn DataField="E_Date_Estimated"
                                                ...
                                                HeaderText="Due Date" ReadOnly="True"
                                            ...
                                            <telerik:GridBoundColumn DataField="Recall" FilterControlAltText="Filter Recall column"
                                                HeaderText="Recall" ReadOnly="True" SortExpression="Recall" UniqueName="Recall">
                                                <HeaderStyle Width="70px" Wrap="False" />
                                                <ItemStyle Width="70px" Wrap="True" />
                                            </telerik:GridBoundColumn>
                                        </Columns>
