<%@ Page Language="VB" AutoEventWireup="false" Title="CAMS Event Management - Add New Service Archive Entry" CodeFile="flt_EM_SER_ARC_ADD_RW.aspx.vb" Inherits="EVENT_MANAGEMENT_flt_EM_SER_ARC_ADD_RW" %>
    ...
    <telerik:RadSplitter ID="RadSplitter1" Runat="server" Width="100%" Height="100%" BorderSize="0" BorderStyle="None" LiveResize="True">
        ...
        <telerik:RadPane ID="RadPane2" runat="server" BorderStyle="None" Scrolling="Both" style="text-align: right" Font-Names="Segoe UI" ForeColor="White">
            <table cellspacing="0" style="width: 100%">
                <tr>
                    <td align="left" style="color: #FFFFFF; font-family: 'Segoe UI'; font-size: 16px; font-weight: bold; padding-left: 10px; background-color: #E46C0A;" class="auto-style4">
                    ...
                    <td align="left" style="color: #FFFFFF; font-family: 'Segoe UI'; font-size: 16px; font-weight: bold; padding-left: 15px; height: 45px; background-color: #E46C0A; padding-right: 10px;">
                        ...
                        <table class="style_table_general" >
                            ...
                            <tr>
                                ...
                                <td>
                                    <telerik:RadDatePicker ID="RadDP_Date" Runat="server">
                            ...
                            <tr>
                                ...
                                <td>
                                    <telerik:RadNumericTextBox ID="RadNumTxt_ServiceSMU" Runat="server" 
...
<asp:HiddenField ID="HF_EMP_ID" runat="server" />
    <asp:SqlDataSource ID="SqlDS_PageCount" runat="server" 
        ...
        <asp:SqlDataSource ID="SqlDS_Insert" runat="server" 
            ConnectionString="<%$ ConnectionStrings:CAMSConnectionString %>" 
            SelectCommand="EM_SERVICING_ARC_RG_INSERT_SP" 
            SelectCommandType="StoredProcedure" >
            <SelectParameters>
                <asp:ControlParameter ControlID="RadCB_Asset" Name="SERA_A_ID" PropertyName="SelectedValue" Type="Int32" DefaultValue="0" />
                <asp:ControlParameter ControlID="RadDP_Date" Name="SERA_Date_Service" Type="DateTime" DefaultValue="1900-01-01" />
                <asp:ControlParameter ControlID="lbl_Site_ID" Name="SERA_SITE_ID" PropertyName="Text" Type="String" DefaultValue="0" />
                ...
                <asp:ControlParameter ControlID="lblWhoIsIt" Name="SERA_Created_By" PropertyName="Text" Type="String" DefaultValue="0" />
           ...
           <asp:SqlDataSource ID="SqlDS_SetNextServiceType" runat="server" 
            ...
            ConnectionString="<%$ ConnectionStrings:CAMSConnectionString %>" 
            SelectCommand="SELECT ASSET.A_SITE_ID AS SiteID, SITE.SITE_Name AS SiteName, ATTRIBUTES.ATT_Name AS ServiceType FROM ASSET INNER JOIN SITE ON ASSET.A_SITE_ID = SITE.SITE_ID INNER JOIN ATTRIBUTES ON ASSET.A_ST_ID = ATTRIBUTES.ATT_ID WHERE (ASSET.A_ID = @A_ID)">
                <SelectParameters>
                    <asp:ControlParameter ControlID="RadCB_Asset" Name="A_ID" PropertyName="SelectedValue" />
                </SelectParameters>
        </asp:SqlDataSource>
            <asp:SqlDataSource ID="SqlDS_AssetPreviousSMU" runat="server" 
            ConnectionString="<%$ ConnectionStrings:CAMSConnectionString %>" 
            SelectCommand="SELECT TOP (1) SMU.SMU_Value FROM SMU INNER JOIN ASSET ON ASSET.A_ID = SMU.SMU_A_ID WHERE (ASSET.A_ID = @A_ID) ORDER BY SMU.SMU_WeekEnding DESC">
                <SelectParameters>
                    <asp:ControlParameter ControlID="RadCB_Asset" Name="A_ID" PropertyName="SelectedValue" />
                </SelectParameters>
        </asp:SqlDataSource>
            ...
            ConnectionString="<%$ ConnectionStrings:CAMSConnectionString %>" 
            SelectCommand="SELECT ASSET.A_ID, ASSET.A_Asset_ID FROM ASSET INNER JOIN SERVICING ON SERVICING.SER_A_ID = ASSET.A_ID WHERE (ASSET.A_Status NOT IN ('Trash', 'Delete')) AND (ASSET.A_Activity_Status NOT IN ('Disposed')) AND (SERVICING.SER_Status_ID = 1038) ORDER BY ASSET.A_Asset_ID">
        </asp:SqlDataSource>
                    ...
                    <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server">
                        <AjaxSettings>
                            <telerik:AjaxSetting AjaxControlID="RadCB_Asset">
                                <UpdatedControls>
                                    <telerik:AjaxUpdatedControl ControlID="lbl_Site_ID" />
                                    <telerik:AjaxUpdatedControl ControlID="lbl_Site" />
                                    <telerik:AjaxUpdatedControl ControlID="lbl_Cycle" />
                                    <telerik:AjaxUpdatedControl ControlID="lbl_Previous_SMU" />
                                    <telerik:AjaxUpdatedControl ControlID="lbl_Counter" />
