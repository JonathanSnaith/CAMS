...
Partial Class EVENT_MANAGEMENT_flt_EM_ACTIVE_EVENTS
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        If HF_PageCount.Value = 0 Then
            ...
            HF_PageName.Value = "EM - Active Events"
            Dim qry As New Database.Queries
            qry.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings("CAMSConnectionString").ConnectionString
        ...
        If Not Me.IsPostBack Then
            ...
            GetEventsEM(-1, -1, -1, -1, -1, "", DateFrom.SelectedDate, DateTo.SelectedDate)
        Else
...
#Region "Internal Methods"
    ...
    End Sub
    Private Sub GetEventsEM(ByVal CUS_ID As Integer, SITE_ID As Integer, ByVal A_ID As Integer, ByVal ATT_ID As Integer, ByVal PER_EMP_ID As Integer, ByVal E_Description As String, ByVal DateFrom As DateTime, ByVal DateTo As DateTime)
        Dim qry As New Database.Queries
        qry.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings("CAMSConnectionString").ConnectionString
        Dim ds1 As DataSet = qry.GetEventsEM(CUS_ID, SITE_ID, A_ID, ATT_ID, PER_EMP_ID, E_Description, DateFrom, DateTo) '*ACTIVE EVENTS
...
#End Region
    ...
    Protected Sub RadCB_Customer_SelectedIndexChanged(sender As Object, e As Telerik.Web.UI.RadComboBoxSelectedIndexChangedEventArgs) Handles RadCB_Customer.SelectedIndexChanged
        ...
        Setup_EventTypes_Combo()
        Setup_Engineers_Combo()
        GetEventsEM(RadCB_Customer.SelectedValue, -1, -1, -1, -1, "", DateFrom.SelectedDate, DateTo.SelectedDate)
        HF_Customer.Value = RadCB_Customer.SelectedValue
    End Sub
    Protected Sub RadCB_Site_SelectedIndexChanged(sender As Object, e As Telerik.Web.UI.RadComboBoxSelectedIndexChangedEventArgs) Handles RadCB_Site.SelectedIndexChanged
        ...
        Setup_EventTypes_Combo()
        Setup_Engineers_Combo()
        GetEventsEM(RadCB_Customer.SelectedValue, RadCB_Site.SelectedValue, -1, -1, -1, "", DateFrom.SelectedDate, DateTo.SelectedDate)
    End Sub
    Protected Sub RadCB_Asset_SelectedIndexChanged(sender As Object, e As Telerik.Web.UI.RadComboBoxSelectedIndexChangedEventArgs) Handles RadCB_Asset.SelectedIndexChanged
        ...
        Setup_EventTypes_Combo()
        Setup_Engineers_Combo()
        GetEventsEM(RadCB_Customer.SelectedValue, RadCB_Site.SelectedValue, RadCB_Asset.SelectedValue, -1, -1, "", DateFrom.SelectedDate, DateTo.SelectedDate)
    End Sub
    Protected Sub RadCB_EventType_SelectedIndexChanged(sender As Object, e As Telerik.Web.UI.RadComboBoxSelectedIndexChangedEventArgs) Handles RadCB_EventType.SelectedIndexChanged
        ...
        Setup_Engineers_Combo()
        GetEventsEM(RadCB_Customer.SelectedValue, RadCB_Site.SelectedValue, RadCB_Asset.SelectedValue, RadCB_EventType.SelectedValue, -1, "", DateFrom.SelectedDate, DateTo.SelectedDate)
    End Sub
    Protected Sub RadCB_Engineer_SelectedIndexChanged(sender As Object, e As Telerik.Web.UI.RadComboBoxSelectedIndexChangedEventArgs) Handles RadCB_Engineer.SelectedIndexChanged
        ...
        GetEventsEM(RadCB_Customer.SelectedValue, RadCB_Site.SelectedValue, RadCB_Asset.SelectedValue, RadCB_EventType.SelectedValue, RadCB_Engineer.SelectedValue, "", DateFrom.SelectedDate, DateTo.SelectedDate)
    End Sub
    Protected Sub RadTxt_Instruction_TextChanged(sender As Object, e As EventArgs) Handles RadTxt_Instruction.TextChanged
        GetEventsEM(-1, -1, -1, -1, -1, RadTxt_Instruction.Text, DateFrom.SelectedDate, DateTo.SelectedDate)
    End Sub
