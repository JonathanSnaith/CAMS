<%@ Page Language="VB" AutoEventWireup="false" Title="CAMS Customer Management - Site List" CodeFile="flt_SITE_LIST.aspx.vb" Inherits="CUSTOMER_MANAGEMENT_flt_SITE_LIST" %>
...
<script type="text/javascript">
    ...
    function RowSelected(sender, eventArgs) {
        var ATTid = sender.get_selectedItems()[0].getDataKeyValue('SITE_ID');
        document.getElementById('HF_SITE_ID').value = ATTid;
        sessionStorage.setItem("SITE_ID", ATTid);
    }
    ...
    function fn_OnClickButton() {
        ...
        oWnd.setUrl('flt_SITE_LIST_EDIT_RW.aspx?FLT_GUID=' + THISGUID + '&SITE_ID=' + THISSITE + '&PreviousPage=0', 'newwindow', 'target=_blank, top=50, left=200, height=350, width=750, status=no, menubar=no, resizable=no, location=no');
        oWnd.show();
    }
    function fn_OnClickWindow() {
        var THISGUID = document.getElementById('HF_GUID').value;
        var THISSITE = sessionStorage.getItem("SITE_ID");
        var oWnd = $find("<%=RadWindow2.ClientID%>");
        oWnd.setUrl('flt_SITE_LIST_EDIT_RW.aspx?FLT_GUID=' + THISGUID + '&SITE_ID=' + THISSITE + '&PreviousPage=0', 'newwindow', 'target=_blank, top=50, left=200, height=350, width=750, status=no, menubar=no, resizable=no, location=no');
        oWnd.show();
    }
...
<body>
    <form id="form1" runat="server">
        <div style="font-family: 'Arial Rounded MT Bold'; font-size: 18px; text-align: left; height: 100%;">
            ...
            <table class="style1" cellspacing="0" style="line-height: 50px">
                        <tr>
                            <td align="left" style="color: White; font-family: 'Segoe UI'; font-size: 20px; padding-left: 15px; background-color: #747474; text-align: center; font-weight: bold;" class="auto-style3">
                                 <asp:Label ID="lblTitle" runat="server" Text="SITE LIST" Font-Bold="False" ForeColor="White"></asp:Label>
                            </td>
                                ...
                                <asp:Table ID="T1" runat="server" Height="75px" Style="cursor: pointer" Width="380px">
                                    ...
                                    <asp:Panel ID="Panel_1" runat="server" onClick="fn_OnClickButton()" CssClass="roundcorners" BackColor="#e7e7e7">
                                        <table border="0">
                                            ...
                                            <tr>
                                                <td class="metro_400x75_cell_content_bottom_left">&#160;<asp:Label ID="Label34" runat="server" Text="NEW SITE" ForeColor="Black"></asp:Label>
                                                </td>
                                            </tr>
                                        </table>
                                    </asp:Panel>
                    ...
                    <table >
                        <tr>
                            <td class="style8" style="text-align: left; vertical-align: top;" colspan="2">
                                <telerik:RadGrid ID="RadGrid_Site_List" runat="server" AllowAutomaticInserts="True" AllowAutomaticUpdates="True" AllowSorting="True"
                                    ...
                                    <MasterTableView AutoGenerateColumns="False" ClientDataKeyNames="SITE_ID" DataKeyNames="SITE_ID" >
                                        ...
                                        <Columns>
                                            <telerik:GridBoundColumn DataField="SITE_ID" DataType="System.Int32"
                                                Display="True" FilterControlAltText="Filter SITE_ID column" HeaderText="ID"
                                            ...
                                            <telerik:GridBoundColumn DataField="SITE_Name" Display="True"
                                             ...
                                             <telerik:GridBoundColumn DataField="SITE_Address_Type"
                                                FilterControlAltText="Filter SITE_Address_Type column"
                                                HeaderText="Address Type" ReadOnly="True" SortExpression="SITE_Address_Type"
                                                UniqueName="SITE_Address_Type">
                                                <HeaderStyle Width="100px" Wrap="False" />
                                                <ItemStyle Width="100px" Wrap="True" />
                                            </telerik:GridBoundColumn>
                                             <telerik:GridBoundColumn DataField="SITE_City"
                                                FilterControlAltText="Filter SITE_City column"
                                                HeaderText="City" ReadOnly="True" SortExpression="SITE_City"
                                                UniqueName="SITE_City">
                                                <HeaderStyle Width="100px" Wrap="False" />
                                                <ItemStyle Width="100px" Wrap="True" />
                                            </telerik:GridBoundColumn>
                                             <telerik:GridBoundColumn DataField="SITE_Status"
                                                FilterControlAltText="Filter SITE_Status column"
                                                HeaderText="Status" ReadOnly="True" SortExpression="SITE_Status"
                                                UniqueName="SITE_Status">
                                                <HeaderStyle Width="100px" Wrap="False" />
                                                <ItemStyle Width="100px" Wrap="True" />
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="SITE_Date_Created" Display="True"
                                                DataFormatString="{0:dd MMM yyyy}"
                                                FilterControlAltText="Filter SITE_Date_Created column" HeaderText="Date Created"
                                                ReadOnly="True" SortExpression="SITE_Date_Created" UniqueName="SITE_Date_Created">
                                                <HeaderStyle Width="100px" Wrap="False" />
                                                <ItemStyle Width="100px" Wrap="False" />
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="SITE_Created_By" Display="False"
                                                FilterControlAltText="Filter SITE_Created_By column" HeaderText="Created By"
                                                ReadOnly="True" SortExpression="SITE_Created_By" UniqueName="SITE_Created_By">
                                                <HeaderStyle Width="200px" Wrap="False" />
                                                <ItemStyle Width="200px" Wrap="True" />
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="SITE_Date_Modified" Display="False"
                                                DataFormatString="{0:dd MMM yyyy}"
                                                FilterControlAltText="Filter SITE_Date_Modified column" HeaderText="Date Modified"
                                                ReadOnly="True" SortExpression="SITE_Date_Modified" UniqueName="SITE_Date_Modified">
                                                <HeaderStyle Width="100px" Wrap="False" />
                                                <ItemStyle Width="100px" Wrap="False" />
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="SITE_Modified_By" Display="False"
                                                FilterControlAltText="Filter SITE_Modified_By column" HeaderText="Modified By"
                                                ReadOnly="True" SortExpression="SITE_Modified_By" UniqueName="SITE_Modified_By">
                                                <HeaderStyle Width="200px" Wrap="False" />
                                                <ItemStyle Width="200px" Wrap="True" />
                                            </telerik:GridBoundColumn>
                                        </Columns>
            ...
            <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server" DefaultLoadingPanelID="RadAjaxLoadingPanel1" RequestQueueSize="1">
                <AjaxSettings>
                    <telerik:AjaxSetting AjaxControlID="RadWindow2">
                        <UpdatedControls>
                            <telerik:AjaxUpdatedControl ControlID="RadGrid_Site_List" />
                        </UpdatedControls>
                    </telerik:AjaxSetting>
            ...
            <telerik:RadWindow ID="RadWindow2" runat="server" Height="600px" Width="550px" OnClientClose="closeWindow_add_event" Behaviors="Close, Move" Modal="True" Title="Edit Site" VisibleStatusbar="False" KeepInScreenBounds="True" ShowContentDuringLoad="False" Skin="Glow">
            </telerik:RadWindow>
        </div>
    </form>
</body>
