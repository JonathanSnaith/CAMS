<%@ Page Language="VB" AutoEventWireup="false" Title="CAMS Customer Management - Customer Satisfaction Survey List" CodeFile="flt_CUSTOMER_SATISFACTION_SURVEY_LIST.aspx.vb" Inherits="CUSTOMER_MANAGEMENT_flt_CUSTOMER_SATISFACTION_SURVEY_LIST" %>
...
<script type="text/javascript">
    ...
    function RowSelected(sender, eventArgs) {
        var ATTid = sender.get_selectedItems()[0].getDataKeyValue('CS_ID');
        document.getElementById('HF_CS_ID').value = ATTid;
        sessionStorage.setItem("CS_ID", ATTid);
    }
    ...
    function fn_OnClickButton() {
        ...
        oWnd.setUrl('flt_CUSTOMER_SATISFACTION_SURVEY_LIST_EDIT_RW.aspx?FLT_GUID=' + THISGUID + '&CS_ID=' + THISCS + '&PreviousPage=0', 'newwindow', 'target=_blank, top=50, left=200, height=350, width=750, status=no, menubar=no, resizable=no, location=no');
        oWnd.show();

    }
    function fn_OnClickWindow() {
        var THISGUID = document.getElementById('HF_GUID').value;
        var THISCS = sessionStorage.getItem("CS_ID");
        var oWnd = $find("<%=RadWindow2.ClientID%>");
        oWnd.setUrl('flt_CUSTOMER_SATISFACTION_SURVEY_LIST_EDIT_RW.aspx?FLT_GUID=' + THISGUID + '&CS_ID=' + THISCS + '&PreviousPage=0', 'newwindow', 'target=_blank, top=50, left=200, height=350, width=750, status=no, menubar=no, resizable=no, location=no');
        oWnd.show();
    }
    ...
    <form id="form1" runat="server">
        <div style="font-family: 'Arial Rounded MT Bold'; font-size: 18px; text-align: left; height: 100%;">
            ...
            <table class="style1" cellspacing="0" style="line-height: 50px">
                        <tr>
                            <td align="left" style="color: White; font-family: 'Segoe UI'; font-size: 14px; padding-left: 15px; background-color: #747474; text-align: center; font-weight: bold;" class="auto-style17">
                                 <asp:Label ID="lblTitle" runat="server" Text="SATISFACTION SURVEYS" Font-Bold="False" ForeColor="White"></asp:Label>
                            </td>
                                ...
                                <asp:Table ID="T1" runat="server" Height="75px" Style="cursor: pointer" Width="380px">
                                    ...
                                    <asp:Panel ID="Panel_1" runat="server" onClick="fn_OnClickButton()" CssClass="roundcorners" BackColor="#e7e7e7">
                                        <table border="0">
                                            ...
                                            <tr>
                                                <td class="metro_400x75_cell_content_bottom_left">&#160;<asp:Label ID="Label34" runat="server" Text="NEW SURVEY" ForeColor="Black"></asp:Label>
                                                </td>
                                            </tr>
                                        </table>
                                    </asp:Panel>
                    ...
                    <table >
                        <tr>
                            <td class="style8" style="text-align: left; vertical-align: top;">
                                <telerik:RadGrid ID="RadGrid_Customer_Satisfaction_Survey_List" runat="server" AllowAutomaticInserts="True" AllowAutomaticUpdates="True" AllowSorting="True"
                                    ResolvedRenderMode="Classic" Skin="Glow"  RegisterWithScriptManager="True">
                                    ...
                                    <MasterTableView AutoGenerateColumns="False" ClientDataKeyNames="CS_ID" DataKeyNames="CS_ID" >
                                        ...
                                        <Columns>
                                            <telerik:GridBoundColumn DataField="CS_ID" DataType="System.Int32"
                                                Display="True" FilterControlAltText="Filter CS_ID column" HeaderText="ID"
                                                ReadOnly="True" SortExpression="CS_ID" UniqueName="CS_ID">
                                            ...
                                            <telerik:GridBoundColumn DataField="PER_Fullname" Display="True"
                                                FilterControlAltText="Filter PER_Fullname column" HeaderText="Engineer"
                                                ReadOnly="True" SortExpression="PER_Fullname" UniqueName="PER_Fullname">
                                                <HeaderStyle Width="250px" Wrap="False" />
                                                <ItemStyle Width="250px" Wrap="False" />
                                            </telerik:GridBoundColumn>
                                             <telerik:GridBoundColumn DataField="CS_Q1"
                                                FilterControlAltText="Filter CS_Q1 column"
                                                HeaderText="Q1" ReadOnly="True" SortExpression="CS_Q1"
                                                UniqueName="CS_Q1">
                                                <HeaderStyle Width="50px" Wrap="False" />
                                                <ItemStyle Width="50px" Wrap="True" />
                                            </telerik:GridBoundColumn>
                                             <telerik:GridBoundColumn DataField="CS_Q2"
                                                FilterControlAltText="Filter CS_Q2 column"
                                                HeaderText="Q2" ReadOnly="True" SortExpression="CS_Q2"
                                                UniqueName="CS_Q2">
                                                <HeaderStyle Width="50px" Wrap="False" />
                                                <ItemStyle Width="50px" Wrap="True" />
                                            </telerik:GridBoundColumn>
                                             <telerik:GridBoundColumn DataField="CS_Q3"
                                                FilterControlAltText="Filter CS_Q3 column"
                                                HeaderText="Q3" ReadOnly="True" SortExpression="CS_Q3"
                                                UniqueName="CS_Q3">
                                                <HeaderStyle Width="50px" Wrap="False" />
                                                <ItemStyle Width="50px" Wrap="True" />
                                            </telerik:GridBoundColumn>
                                             <telerik:GridBoundColumn DataField="CS_Q4"
                                                FilterControlAltText="Filter CS_Q4 column"
                                                HeaderText="Q4" ReadOnly="True" SortExpression="CS_Q4"
                                                UniqueName="CS_Q4">
                                                <HeaderStyle Width="50px" Wrap="False" />
                                                <ItemStyle Width="50px" Wrap="True" />
                                            </telerik:GridBoundColumn>
                                             <telerik:GridBoundColumn DataField="CS_Q5"
                                                FilterControlAltText="Filter CS_Q5 column"
                                                HeaderText="Q5" ReadOnly="True" SortExpression="CS_Q5"
                                                UniqueName="CS_Q5">
                                                <HeaderStyle Width="50px" Wrap="False" />
                                                <ItemStyle Width="50px" Wrap="True" />
                                            </telerik:GridBoundColumn>
                                             <telerik:GridBoundColumn DataField="CS_Q6"
                                                FilterControlAltText="Filter CS_Q6 column"
                                                HeaderText="Q6" ReadOnly="True" SortExpression="CS_Q6"
                                                UniqueName="CS_Q6">
                                                <HeaderStyle Width="50px" Wrap="False" />
                                                <ItemStyle Width="50px" Wrap="True" />
                                            </telerik:GridBoundColumn>
                                             <telerik:GridBoundColumn DataField="CS_Q7"
                                                FilterControlAltText="Filter CS_Q7 column"
                                                HeaderText="Q7" ReadOnly="True" SortExpression="CS_Q7"
                                                UniqueName="CS_Q7">
                                                <HeaderStyle Width="50px" Wrap="False" />
                                                <ItemStyle Width="50px" Wrap="True" />
                                            </telerik:GridBoundColumn>
                                             <telerik:GridBoundColumn DataField="CS_Q8"
                                                FilterControlAltText="Filter CS_Q8 column"
                                                HeaderText="Q8" ReadOnly="True" SortExpression="CS_Q8"
                                                UniqueName="CS_Q8">
                                                <HeaderStyle Width="50px" Wrap="False" />
                                                <ItemStyle Width="50px" Wrap="True" />
                                            </telerik:GridBoundColumn>
                                             <telerik:GridBoundColumn DataField="CS_Q9"
                                                FilterControlAltText="Filter CS_Q9 column"
                                                HeaderText="Q9" ReadOnly="True" SortExpression="CS_Q9"
                                                UniqueName="CS_Q9">
                                                <HeaderStyle Width="50px" Wrap="False" />
                                                <ItemStyle Width="50px" Wrap="True" />
                                            </telerik:GridBoundColumn>
                                             <telerik:GridBoundColumn DataField="CS_Q10"
                                                FilterControlAltText="Filter CS_Q10 column"
                                                HeaderText="Q10" ReadOnly="True" SortExpression="CS_Q10"
                                                UniqueName="CS_Q10">
                                                <HeaderStyle Width="50px" Wrap="False" />
                                                <ItemStyle Width="50px" Wrap="True" />
                                            </telerik:GridBoundColumn>
                                             <telerik:GridBoundColumn DataField="CS_Q11"
                                                FilterControlAltText="Filter CS_Q11 column"
                                                HeaderText="Q11" ReadOnly="True" SortExpression="CS_Q11"
                                                UniqueName="CS_Q11">
                                                <HeaderStyle Width="50px" Wrap="False" />
                                                <ItemStyle Width="50px" Wrap="True" />
                                            </telerik:GridBoundColumn>
                                             <telerik:GridBoundColumn DataField="CS_Q12"
                                                FilterControlAltText="Filter CS_Q12 column"
                                                HeaderText="Q12" ReadOnly="True" SortExpression="CS_Q12"
                                                UniqueName="CS_Q12">
                                                <HeaderStyle Width="50px" Wrap="False" />
                                                <ItemStyle Width="50px" Wrap="True" />
                                            </telerik:GridBoundColumn>
                                             <telerik:GridBoundColumn DataField="CS_Q13"
                                                FilterControlAltText="Filter CS_Q13 column"
                                                HeaderText="Q13" ReadOnly="True" SortExpression="CS_Q13"
                                                UniqueName="CS_Q13">
                                                <HeaderStyle Width="50px" Wrap="False" />
                                                <ItemStyle Width="50px" Wrap="True" />
                                            </telerik:GridBoundColumn>
                                             <telerik:GridBoundColumn DataField="CS_Q14"
                                                FilterControlAltText="Filter CS_Q14 column"
                                                HeaderText="Q14" ReadOnly="True" SortExpression="CS_Q14"
                                                UniqueName="CS_Q14">
                                                <HeaderStyle Width="50px" Wrap="False" />
                                                <ItemStyle Width="50px" Wrap="True" />
                                            </telerik:GridBoundColumn>
                                             <telerik:GridBoundColumn DataField="CS_Total"
                                                FilterControlAltText="Filter CS_Total column"
                                                HeaderText="Total" ReadOnly="True" SortExpression="CS_Total"
                                                UniqueName="CS_Total">
                                                <HeaderStyle Width="50px" Wrap="False" />
                                                <ItemStyle Width="50px" Wrap="True" />
                                            </telerik:GridBoundColumn>
                                             <telerik:GridBoundColumn DataField="CS_Total_PCT"
                                                FilterControlAltText="Filter CS_Total_PCT column"
                                                HeaderText="Total (%)" ReadOnly="True" SortExpression="CS_Total_PCT"
                                                UniqueName="CS_Total_PCT">
                                                <HeaderStyle Width="50px" Wrap="False" />
                                                <ItemStyle Width="50px" Wrap="True" />
                                            </telerik:GridBoundColumn>
                                             <telerik:GridBoundColumn DataField="CS_Status"
                                                FilterControlAltText="Filter CS_Status column"
                                                HeaderText="Status" ReadOnly="True" SortExpression="CS_Status"
                                                UniqueName="CS_Status">
                                                <HeaderStyle Width="100px" Wrap="False" />
                                                <ItemStyle Width="100px" Wrap="True" />
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="CS_Created" Display="True"
                                                DataFormatString="{0:dd MMM yyyy}"
                                                FilterControlAltText="Filter CS_Created column" HeaderText="Date Created"
                                                ReadOnly="True" SortExpression="CS_Created" UniqueName="CS_Created">
                                                <HeaderStyle Width="100px" Wrap="False" />
                                                <ItemStyle Width="100px" Wrap="False" />
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="CS_Created_By" Display="False"
                                                FilterControlAltText="Filter CS_Created_By column" HeaderText="Created By"
                                                ReadOnly="True" SortExpression="CS_Created_By" UniqueName="CS_Created_By">
                                                <HeaderStyle Width="200px" Wrap="False" />
                                                <ItemStyle Width="200px" Wrap="True" />
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="CS_Modified" Display="False"
                                                DataFormatString="{0:dd MMM yyyy}"
                                                FilterControlAltText="Filter CS_Modified column" HeaderText="Date Modified"
                                                ReadOnly="True" SortExpression="CS_Modified" UniqueName="CS_Modified">
                                                <HeaderStyle Width="100px" Wrap="False" />
                                                <ItemStyle Width="100px" Wrap="False" />
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="CS_Modified_By" Display="False"
                                                FilterControlAltText="Filter CS_Modified_By column" HeaderText="Modified By"
                                                ReadOnly="True" SortExpression="CS_Modified_By" UniqueName="CS_Modified_By">
                                                <HeaderStyle Width="200px" Wrap="False" />
                                                <ItemStyle Width="200px" Wrap="True" />
                                            </telerik:GridBoundColumn>
                                        </Columns>
            ...
            <telerik:RadNotification ID="RadNotify" runat="server" Position="Center" Title="CAMS - Problem" Height="100px" Skin="Silk" TitleMenuToolTip="" Width="600px">
            ...
            <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server" DefaultLoadingPanelID="RadAjaxLoadingPanel1" RequestQueueSize="1">
                <AjaxSettings>
                    <telerik:AjaxSetting AjaxControlID="RadWindow2">
                        <UpdatedControls>
                            <telerik:AjaxUpdatedControl ControlID="RadGrid_Customer_Satisfaction_Survey_List" />
                        </UpdatedControls>
                    </telerik:AjaxSetting>
            ...
            <telerik:RadWindow ID="RadWindow2" runat="server" Height="750px" Width="1150px" OnClientClose="closeWindow_add_event" Behaviors="Close, Move" Modal="True" Title="Edit Contact" VisibleStatusbar="False" KeepInScreenBounds="True" ShowContentDuringLoad="False">
            </telerik:RadWindow>
        </div>
    </form>
</body>
