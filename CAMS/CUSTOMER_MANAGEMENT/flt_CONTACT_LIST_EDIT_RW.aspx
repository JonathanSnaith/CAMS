<%@ Page Language="VB" AutoEventWireup="false" Title="Customer Management - Contact List - Add/Edit Contact" CodeFile="flt_CONTACT_LIST_EDIT_RW.aspx.vb" Inherits="CUSTOMER_MANAGEMENT_flt_CONTACT_LIST_EDIT_RW" %>
...
<body>
    <script type="text/javascript">
        ...
        function closeWindow() {
            var oWnd = GetRadWindow();
            var ThisVal = document.getElementById('HF_CON_ID').value;
            oWnd.close(ThisVal);
        }
    </script>
                    ...
                    <table cellspacing="0" style="width: 100%">
                        <tr>
                            ...
                            <td align="left" style="color: #FFFFFF; font-family: 'Segoe UI'; font-size: 16px; font-weight: bold; padding-left: 15px; height: 45px; background-color: #ff661c; padding-right: 10px;">
                                <asp:Label ID="lblTitle" runat="server" BackColor="#ff661c" Font-Size="16px" ForeColor="White"  Text="EDIT CONTACT" Visible="true"></asp:Label>
                            </td>
                        </tr>
                    </table>
                            ...
                            <table class="style_table_general" style="vertical-align: top;">
                                <tr valign="top">
                                    ...
                                    <td class="auto-style4">
                                        <telerik:RadTextBox ID="RadTxt_Contact_Name" runat="server" Skin="Glow" Width="300px">
                                        </telerik:RadTextBox>
                                    </td>
                                    <td style="padding-left: 20px" class="auto-style4"></td>
                                    <td class="style1" style="padding-left: 20px" rowspan="8">&nbsp;</td>
                                    <td rowspan="8">
                                        &nbsp;</td>
                                </tr>
                                <tr valign="top">
                                ...
                                <tr valign="top">
                                    <td class="auto-style3" style="padding-right: 20px" valign="top">Site:</td>
                                    <td class="auto-style4">
                                        <telerik:RadComboBox ID="RadCB_Site" runat="server" AutoPostBack="True" DataTextField="SITE_Name" DataValueField="SITE_ID" Filter="Contains" ResolvedRenderMode="Classic" Skin="Glow" Width="300px">
                                        </telerik:RadComboBox>
                                    </td>
                                    <td class="auto-style4" style="padding-left: 20px">&nbsp;</td>
                                </tr>
                                <tr valign="top">
                                    <td class="auto-style3" style="padding-right: 20px" valign="top">Position:</td>
                                    <td class="auto-style4">
                                        <telerik:RadTextBox ID="RadTxt_Position" runat="server" Skin="Glow" Width="300px">
                                        </telerik:RadTextBox>
                                    </td>
                                    <td class="auto-style4" style="padding-left: 20px">&nbsp;</td>
                                </tr>
                                <tr valign="top">
                                    <td class="auto-style3" style="padding-right: 20px" valign="top">Level:</td>
                                    <td class="auto-style4">
                                        <telerik:RadComboBox ID="RadCB_Level" runat="server" Skin="Glow">
                                            <Items>
                                                <telerik:RadComboBoxItem runat="server" Text="Primary" Value="Primary" />
