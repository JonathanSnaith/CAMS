...
Partial Class CUSTOMER_MANAGEMENT_flt_CUSTOMER_LIST
    ...
    Protected Sub Page_Init(sender As Object, e As System.EventArgs) Handles Me.Init
        ...
        Me.RadGrid_Customer_List.Visible = True
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        If HF_PageCount.Value = 0 Then
            ...
            HF_PageName.Value = "CM - Customer List"
            Dim qry As New Database.Queries
            qry.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings("CAMSConnectionString").ConnectionString
    ...
    Sub WhichRowSelected()
        ...
        For Each item As Telerik.Web.UI.GridDataItem In RadGrid_Customer_List.Items
            Dim intCategoryID As Integer = Convert.ToInt32(item("CUS_ID").Text)
            count = count + 1
    ...
    Sub SelectCorrectRecord()
        Dim count As Integer = 0
        For Each item As Telerik.Web.UI.GridDataItem In RadGrid_Customer_List.Items
            Dim EventIDCell As TableCell = item("CUS_ID")
            Dim EventID = EventIDCell.Text
            count = count + 1
            If Session("CUS_ID") = "null" Then Session("CUS_ID") = "0"

            If Session("CUS_ID") = EventID Then
                item.Selected = True
            End If
        Next
    End Sub
#Region "Internal Methods"
    ...
    Private Sub GetData(ByVal CUS_ID As Integer)
        ...
        Dim ds As DataSet = qry.GetCustomerList(CUS_ID)
        Dim dtMain As DataTable
        dtMain = ds.Tables(0)

        RadGrid_Customer_List.DataSource = dtMain
        RadGrid_Customer_List.DataBind()
    End Sub
#End Region
