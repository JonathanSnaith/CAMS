...
Partial Class VIEWS_AUDIT_view_EVENT_INCOMPLETE_FIELDS
    ...
    Protected Sub RadGrid1_ItemDataBound(sender As Object, e As Telerik.Web.UI.GridItemEventArgs) Handles RadGrid1.ItemDataBound
        For Each item As GridDataItem In RadGrid1.Items
            Dim Img1 As Image = DirectCast(item("PlannedStartDate").Controls(0), Image)
            ...
            End Select
            Dim Img2 As Image = DirectCast(item("EstimatedDueBack").Controls(0), Image)
