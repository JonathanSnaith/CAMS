<%@ Page Language="VB" AutoEventWireup="false" Title="FLEET- Auditing - Events with Expired Estimated Due Back Dates" CodeFile="view_EVENT_EXPIRED_ESTIMATED.aspx.vb" Inherits="VIEWS_AUDIT_view_EVENT_EXPIRED_ESTIMATED" %>
    ...
    <table cellspacing="0" style="height: 75px; background-color: #E46C0A; color: #FFFFFF;" width="100%" >
            <tr>
                    <td  style="padding-top: 3px; padding-left: 10px; font-family: 'Segoe UI'; font-size: 26px; vertical-align: bottom;">
                        Events with Expired Due Back Dates </td>
...
<asp:HiddenField ID="HF_EMP_ID" runat="server" />
        ...
        <asp:SqlDataSource ID="SqlDS_Events" runat="server" 
            ConnectionString="<%$ ConnectionStrings:CAMSConnectionString %>" 
            SelectCommand="REPORT_AUDIT_EVENT_EXPIRED_ESTIMATED_LIST_SP" SelectCommandType="StoredProcedure">
        </asp:SqlDataSource>
