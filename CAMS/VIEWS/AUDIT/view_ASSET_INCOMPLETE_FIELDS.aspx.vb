...
Partial Class VIEWS_AUDIT_view_ASSET_INCOMPLETE_FIELDS
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        lblPageName.Text = "Home - Reports - Audit - Incomplete Asset Fields"
        Me.SqlDS_PageCount.Select(DataSourceSelectArguments.Empty)
    End Sub
    Protected Sub RadGrid1_ItemDataBound(sender As Object, e As Telerik.Web.UI.GridItemEventArgs) Handles RadGrid1.ItemDataBound
        For Each item As GridDataItem In RadGrid1.Items
            Dim Img1 As Image = DirectCast(item("PrimaryGroup").Controls(0), Image)
            ...
            End Select
            Dim Img2 As Image = DirectCast(item("SecondaryGroup").Controls(0), Image)
            ...
            End Select
            Dim Img3 As Image = DirectCast(item("Manufacturer").Controls(0), Image)
            ...
            End Select
            Dim Img4 As Image = DirectCast(item("Model").Controls(0), Image)
            ...
            End Select
            Dim Img5 As Image = DirectCast(item("Category").Controls(0), Image)
            Select Case Img5.AlternateText
                Case "Yes"
                    Img5.ImageUrl = "../../IMAGES/24x24/supplier_do_not_use_24x24.png"
                Case Else
                    Img5.ImageUrl = "../../IMAGES/24x24/blank_24x24.png"
            End Select
        Next
    End Sub
End Class