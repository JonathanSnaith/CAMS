<%@ Page Language="VB" AutoEventWireup="false" Title="FLEET- Home - Overdue Services" CodeFile="view_HOME_OVERDUE_SERVICES.aspx.vb" Inherits="VIEWS_HOME_OVERDUE_SERVICES" %>
    ...
    <form id="form1" runat="server">
        <div style="font-family: 'Arial Rounded MT Bold'; font-size: 18px; text-align: left; height: 100%;">
            <table cellspacing="0" style="height: 75px; background-color: #E46C0A; color: #FFFFFF;" width="100%">
                <tr>
                    <td style="padding-top: 3px; padding-left: 10px; font-family: 'Segoe UI'; font-size: 26px; vertical-align: bottom;">Overdue Services </td>
            ...
            <telerik:RadGrid ID="RadGrid1" runat="server" DataSourceID="SqlDS_Events" Skin="Silk" ResolvedRenderMode="Classic" AllowSorting="True">
                ...
                <MasterTableView AutoGenerateColumns="False" DataSourceID="SqlDS_Events" DataKeyNames="SER_ID" NoMasterRecordsText="No records to display." CommandItemDisplay="Top">
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="Description" Display="True"
                        ...
                        <telerik:GridBoundColumn DataField="SER_External" Display="True"
                            FilterControlAltText="Filter SER_External column" HeaderText="External?"
                            ReadOnly="True" SortExpression="SER_External" UniqueName="SER_External">
                            <HeaderStyle Width="100px" Wrap="False" />
                            <ItemStyle Width="100px" Wrap="False" />
                        </telerik:GridBoundColumn>
                    </Columns>
            ...
            <asp:SqlDataSource ID="SqlDS_Events" runat="server"
                ConnectionString="<%$ ConnectionStrings:CAMSConnectionString %>"
                SelectCommand="HOME_OVERDUE_SERVICES_LIST_SP" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
        </div>
    </form>
</body>
</html>
