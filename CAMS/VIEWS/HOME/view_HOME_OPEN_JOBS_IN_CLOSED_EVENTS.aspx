<%@ Page Language="VB" AutoEventWireup="false" Title="FLEET- Home - Open Jobs in Closed Events" CodeFile="view_HOME_OPEN_JOBS_IN_CLOSED_EVENTS.aspx.vb" Inherits="VIEWS_HOME_OPEN_JOBS_IN_CLOSED_EVENTS" %>
    ...
    <form id="form1" runat="server">
        <div style="font-family: 'Arial Rounded MT Bold'; font-size: 18px; text-align: left; height: 100%;">
            <table cellspacing="0" style="height: 75px; background-color: #E46C0A; color: #FFFFFF;" width="100%">
                <tr>
                    <td style="padding-top: 3px; padding-left: 10px; font-family: 'Segoe UI'; font-size: 26px; vertical-align: bottom;">Open Jobs in Closed Events </td>
            ...
            <asp:SqlDataSource ID="SqlDS_Events" runat="server"
                ConnectionString="<%$ ConnectionStrings:CAMSConnectionString %>"
                SelectCommand="HOME_OPEN_JOBS_IN_CLOSED_EVENTS_LIST_SP" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
        </div>
    </form>
</body>
</html>
