<%@ Page Language="VB" AutoEventWireup="false" Title="FLEET- Home - Average time to complete Jobs" CodeFile="view_HOME_AVG_TIME_COMPLETE_JOBS.aspx.vb" Inherits="VIEWS_HOME_AVG_TIME_COMPLETE_JOBS" %>
    ...
    <form id="form1" runat="server">
        <div style="font-family: 'Arial Rounded MT Bold'; font-size: 18px; text-align: left; height: 100%;">
            <table cellspacing="0" style="height: 75px; background-color: #E46C0A; color: #FFFFFF;" width="100%">
                <tr>
                    <td style="padding-top: 3px; padding-left: 10px; font-family: 'Segoe UI'; font-size: 26px; vertical-align: bottom;">Average time to complete Jobs</td>
                ...
                <MasterTableView AutoGenerateColumns="False" DataSourceID="SqlDS_Events" DataKeyNames="E_ID" NoMasterRecordsText="No records to display." CommandItemDisplay="Top">
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="E_Planned_Start_Date"
                          ...
                          <telerik:GridBoundColumn DataField="J_Date_Closed"
                            DataFormatString="{0:dd MMM yyyy}" Display="True"
                            FilterControlAltText="Filter J_Date_Closed column"
                            HeaderText="Job Closed" ReadOnly="True"
                            SortExpression="J_Date_Closed" UniqueName="J_Date_Closed">
                            <HeaderStyle Width="90px" Wrap="False" />
                            <ItemStyle Width="90px" Wrap="False" />
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="DiffDays"
                            FilterControlAltText="Filter DiffDays column" HeaderText="Difference (Days)"
                            ReadOnly="True" SortExpression="DiffDays" UniqueName="DiffDays">
            ...
            <asp:SqlDataSource ID="SqlDS_Events" runat="server"
                ConnectionString="<%$ ConnectionStrings:CAMSConnectionString %>"
                SelectCommand="HOME_AVG_TIME_TO_COMPLETE_JOB_CARDS_LIST_SP" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
        </div>
    </form>
</body>
</html>
