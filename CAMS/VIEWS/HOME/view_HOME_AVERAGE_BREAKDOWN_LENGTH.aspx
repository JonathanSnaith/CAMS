<%@ Page Language="VB" AutoEventWireup="false" Title="FLEET- Home - Average Length of Breakdowns" CodeFile="view_HOME_AVERAGE_BREAKDOWN_LENGTH.aspx.vb" Inherits="VIEWS_HOME_AVERAGE_BREAKDOWN_LENGTH" %>
    ...
    <form id="form1" runat="server">
        <div style="font-family: 'Arial Rounded MT Bold'; font-size: 18px; text-align: left; height: 100%;">
            <table cellspacing="0" style="height: 75px; background-color: #E46C0A; color: #FFFFFF;" width="100%">
                <tr>
                    <td style="padding-top: 3px; padding-left: 10px; font-family: 'Segoe UI'; font-size: 26px; vertical-align: bottom;">Average Length of Breakdowns </td>
                    ...
                    <Columns>
                       ...
                       <telerik:GridBoundColumn DataField="EventType" Display="True"
                        ...
                        <telerik:GridBoundColumn DataField="E_Date_Started"
                            ...
                            HeaderText="Date Started" ReadOnly="True"
                            SortExpression="E_Date_Started" UniqueName="E_Date_Started">
                            <HeaderStyle Width="90px" Wrap="False" />
                            <ItemStyle Width="90px" Wrap="False" />
                        </telerik:GridBoundColumn>
                         <telerik:GridBoundColumn DataField="E_Date_Ended"
                            DataFormatString="{0:dd MMM yyyy HH:mm}" Display="True"
                            FilterControlAltText="Filter E_Date_Ended column"
                            HeaderText="Date Ended" ReadOnly="True"
                            SortExpression="E_Date_Ended" UniqueName="E_Date_Ended">
                            <HeaderStyle Width="90px" Wrap="False" />
                            <ItemStyle Width="90px" Wrap="False" />
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn DataField="DiffHrs"
                            FilterControlAltText="Filter DiffHrs column" HeaderText="Difference (Hrs)"
                            ReadOnly="True" SortExpression="DiffHrs" UniqueName="DiffHrs">
            ...
            <asp:SqlDataSource ID="SqlDS_Events" runat="server"
                ConnectionString="<%$ ConnectionStrings:CAMSConnectionString %>"
                SelectCommand="HOME_AVERAGE_BREAKDOWN_LENGTH_LIST_SP" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
        </div>
    </form>
</body>
</html>
