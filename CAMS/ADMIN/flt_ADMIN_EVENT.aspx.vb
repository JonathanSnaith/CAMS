...
Partial Class ADMIN_flt_ADMIN_EVENT
...
#Region "Internal Methods"
    Private Sub Setup_Attributes_Combo()
        ...
        RadCB_Attribute_Choice = Setup.Populate_AttributeNames(RadCB_Attribute_Choice, "Events")
    End Sub
    Private Sub GetData(ByVal AttributeTable As String)
        Dim qry As New Database.Queries
        qry.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings("CAMSConnectionString").ConnectionString

        Dim ds As DataSet = qry.GetAttributeEventsList(AttributeTable)
...
#End Region
    Protected Sub RadCB_Attribute_Choice_SelectedIndexChanged(sender As Object, e As Telerik.Web.UI.RadComboBoxSelectedIndexChangedEventArgs) Handles RadCB_Attribute_Choice.SelectedIndexChanged
        ...
        End If
        If abc = "JOB_Type" Then
            RadGrid_Attributes.MasterTableView.GetColumnSafe("ATT_Name_JT").Display = True
            Exit Sub
        Else
            RadGrid_Attributes.MasterTableView.GetColumnSafe("ATT_Name_JT").Display = False
        End If
        If abc = "DEFECT_Type" Then
            RadGrid_Attributes.MasterTableView.GetColumnSafe("ATT_Name_DT").Display = True
            Exit Sub
        Else
            RadGrid_Attributes.MasterTableView.GetColumnSafe("ATT_Name_DT").Display = False
        End If
    End Sub
