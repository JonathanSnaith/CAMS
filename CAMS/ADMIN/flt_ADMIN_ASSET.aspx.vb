...
Partial Class ADMIN_flt_ADMIN_ASSET
...
#Region "Internal Methods"
    Private Sub Setup_Attributes_Combo()
        ...
        RadCB_Attribute_Choice = Setup.Populate_AttributeNames(RadCB_Attribute_Choice, "AssetParts")
    End Sub
    Private Sub GetData(ByVal AttributeTable As String)
        Dim qry As New Database.Queries
        qry.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings("CAMSConnectionString").ConnectionString

        Dim ds As DataSet = qry.GetAttributeAssetPartsList(AttributeTable)
...
#End Region
    Protected Sub RadCB_Attribute_Choice_SelectedIndexChanged(sender As Object, e As Telerik.Web.UI.RadComboBoxSelectedIndexChangedEventArgs) Handles RadCB_Attribute_Choice.SelectedIndexChanged
        ...
        End If
        If abc = "ASSET_Secondary" Then
            RadGrid_Model_Detail.Visible = False
            RadGrid_Attributes.MasterTableView.GetColumnSafe("ATT_Name_Secondary").Display = True
            RadGrid_Attributes.MasterTableView.GetColumnSafe("ATT_Name_Model").Display = False
            RadGrid_Attributes.MasterTableView.GetColumnSafe("ATT_FLAG").Display = False
            Exit Sub
        Else
            RadGrid_Attributes.MasterTableView.GetColumnSafe("ATT_Name_Secondary").Display = False
            RadGrid_Attributes.MasterTableView.GetColumnSafe("ATT_Name_Model").Display = False
            RadGrid_Attributes.MasterTableView.GetColumnSafe("ATT_FLAG").Display = False
        End If

        If abc = "ASSET_Model" Then
            RadGrid_Model_Detail.Visible = True
            RadGrid_Attributes.MasterTableView.GetColumnSafe("ATT_Name_Secondary").Display = False
            RadGrid_Attributes.MasterTableView.GetColumnSafe("ATT_Name_Model").Display = True
            RadGrid_Attributes.MasterTableView.GetColumnSafe("ATT_FLAG").Display = False
            Exit Sub
        Else
            RadGrid_Model_Detail.Visible = False
