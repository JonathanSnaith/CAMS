<%@ Page Language="VB" AutoEventWireup="false" Title="Admin - Other" CodeFile="flt_ADMIN_OTHER.aspx.vb" Inherits="ADMIN_flt_ADMIN_OTHER" %>
...
<script type="text/javascript">
    ...
    function fn_OnClickButton() {
       ...
       var oWnd = $find("<%=RadWindow2.ClientID%>");
        oWnd.setUrl('flt_ADMIN_OTHER_ATTRIBUTE_EDIT_RW.aspx?FLT_GUID=' + THISGUID + '&ATT_ID=' + THISATT + '&ATT_TABLE=' + THISTABLE + '&PreviousPage=0', 'newwindow', 'target=_blank, top=50, left=200, height=350, width=750, status=no, menubar=no, resizable=no, location=no');
        oWnd.show();
    }
                    ...
                    <table class="style1" cellspacing="0" style="line-height: 50px;">
                        <tr>
                            <td align="left" style="color: White; font-family: 'Segoe UI'; font-size: 20px; padding-left: 15px; background-color: #747474; text-align: center; font-weight: bold;" class="auto-style27">
                                <asp:Label ID="lblTitle" runat="server" Text="ADMIN - ALL OTHER TABLES" Font-Bold="False" ForeColor="White"></asp:Label>
                            </td>
