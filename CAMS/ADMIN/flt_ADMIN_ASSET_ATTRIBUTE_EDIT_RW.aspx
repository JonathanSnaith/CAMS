<%@ Page Language="VB" AutoEventWireup="false" Title="Admin - Asset - Edit Attribute" CodeFile="flt_ADMIN_ASSET_ATTRIBUTE_EDIT_RW.aspx.vb" Inherits="ADMIN_flt_ADMIN_ASSET_ATTRIBUTE_EDIT_RW" %>
                        ...
                        <telerik:RadPageView ID="RadPV_GENERAL" runat="server" Selected="True">
                            <table class="style_table_general">
                                ...
                                <tr>
                                    ...
                                    <td colspan="6">
                                        <telerik:RadComboBox ID="RadCB_SecondaryGroup" runat="server" Skin="Glow"
                                        ...
                                        <telerik:RadComboBox ID="RadCB_Model" runat="server" Skin="Glow"
                                            Visible="False" Width="300px" 
                                            DataTextField="ATT_Name" DataValueField="ATT_ID"
                                            ResolvedRenderMode="Classic" AllowCustomText="True" Filter="Contains">
                                        </telerik:RadComboBox>
                                ...
                                <tr>
                                    ...
                                    <td colspan="6">
                                        <telerik:RadTextBox ID="RadTxt_Flag" runat="server" Skin="Glow"
                                            Visible="False" Width="300px">
                                        </telerik:RadTextBox>
                                    </td>
                                    <td style="padding-left: 20px">&nbsp;</td>
