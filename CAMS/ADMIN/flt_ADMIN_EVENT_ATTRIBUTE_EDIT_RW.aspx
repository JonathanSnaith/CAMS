<%@ Page Language="VB" AutoEventWireup="false" Title="Admin - Event - Edit Attribute" CodeFile="flt_ADMIN_EVENT_ATTRIBUTE_EDIT_RW.aspx.vb" Inherits="ADMIN_flt_ADMIN_EVENT_ATTRIBUTE_EDIT_RW" %>
                        ...
                        <telerik:RadPageView ID="RadPV_GENERAL" runat="server" Selected="True">
                            <table class="style_table_general">
                                ...
                                <tr>
                                    ...
                                    <td colspan="6">
                                        <telerik:RadComboBox ID="RadCB_JT" runat="server" Skin="Glow"
                                        ...
                                        <telerik:RadComboBox ID="RadCB_DT" runat="server" AllowCustomText="True"
                                     DataTextField="ATT_Name" DataValueField="ATT_ID"
                                            Filter="Contains" ResolvedRenderMode="Classic" Skin="Glow" Visible="False"
                                            Width="300px">
                                        </telerik:RadComboBox>
                                    </td>
                                    <td style="padding-left: 20px">
                                ...
                                <tr>
                                    ...
                                    <td colspan="6">
                                        <telerik:RadComboBox ID="RadCB_Flag" Runat="server" Visible="False" Skin="Glow">
                                            <Items>
