<%@ Page Language="VB" AutoEventWireup="false" Title="Admin - Codes" CodeFile="flt_ADMIN_SMU.aspx.vb" Inherits="ADMIN_flt_ADMIN_SMU" %>
...
<script type="text/javascript">
    ...
    function fn_OnClickButton() {
       ...
       var oWnd = $find("<%=RadWindow2.ClientID%>");
        oWnd.setUrl('flt_ADMIN_SMU_ATTRIBUTE_EDIT_RW.aspx?FLT_GUID=' + THISGUID + '&ATT_ID=' + THISATT + '&ATT_TABLE=' + THISTABLE + '&PreviousPage=0', 'newwindow', 'target=_blank, top=50, left=200, height=350, width=750, status=no, menubar=no, resizable=no, location=no');
        oWnd.show();
    }
...
<body>
    <form id="form1" runat="server">
        <div style="font-family: 'Arial Rounded MT Bold'; font-size: 18px; text-align: left; height: 100%;">
                    ...
                    <table class="style1" cellspacing="0" style="line-height: 50px;">
                        <tr>
                            <td align="left" style="color: White; font-family: 'Segoe UI'; font-size: 20px; padding-left: 15px; background-color: #747474; text-align: center; font-weight: bold;" class="auto-style27">
                                <asp:Label ID="lblTitle" runat="server" Text="ADMIN - CODES" Font-Bold="False" ForeColor="White"></asp:Label>
                            </td>
                                ...
                                <telerik:RadGrid ID="RadGrid_Attributes" runat="server" AllowAutomaticInserts="True"
                                    ...
                                    <MasterTableView AutoGenerateColumns="False" ClientDataKeyNames="ATT_ID"
                                        ...
                                        <Columns>
                                            ...
                                            <telerik:GridBoundColumn DataField="ATT_FLAG" Display="False"
                                                FilterControlAltText="Filter ATT_FLAG column"
                                                HeaderText="Level" ReadOnly="True" SortExpression="ATT_FLAG"
                                                UniqueName="ATT_FLAG">
                                                <HeaderStyle Width="100px" Wrap="False" />
                                                <ItemStyle Width="100px" Wrap="True" />
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="ATT_Name_Comp_Code" Display="False"
                                                FilterControlAltText="Filter ATT_Name_Comp_Code column"
                                                HeaderText="Level Up" ReadOnly="True" SortExpression="ATT_Name_Comp_Code"
                                                UniqueName="ATT_Name_Comp_Code">
                                                <HeaderStyle Width="250px" Wrap="False" />
                                                <ItemStyle Width="250px" Wrap="True" />
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="ATT_Name_Trigger_Code" Display="False"
                                                FilterControlAltText="Filter ATT_Name_Trigger_Code column"
                                                HeaderText="Trigger Code" ReadOnly="True" SortExpression="ATT_Name_Trigger_Code"
                                                UniqueName="ATT_Name_Trigger_Code">
                                                <HeaderStyle Width="250px" Wrap="False" />
                                                <ItemStyle Width="250px" Wrap="True" />
                                            </telerik:GridBoundColumn>
            ...
            <telerik:RadWindow ID="RadWindow2" runat="server" Height="600px" Width="700px" OnClientClose="closeWindow_add_event" Behaviors="Close, Move" Modal="True" Title="Edit Attribute" VisibleStatusbar="False" KeepInScreenBounds="True" Skin="Glow">
            </telerik:RadWindow>
        </div>
    </form>
</body>
