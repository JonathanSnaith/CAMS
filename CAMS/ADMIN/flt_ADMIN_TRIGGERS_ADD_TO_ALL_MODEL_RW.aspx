<%@ Page Language="VB" AutoEventWireup="false" Title="Admin - TRIGGERS - Add To Model" CodeFile="flt_ADMIN_TRIGGERS_ADD_TO_ALL_MODEL_RW.aspx.vb" Inherits="ADMIN_TRIGGERS_ADD_TO_ALL_MODEL_RW" %>
    ...
    <form id="form1" runat="server">
        <div style="font-family: 'Arial Rounded MT Bold'; font-size: 18px; text-align: left; height: 100%;">
                    ...
                    <telerik:RadMultiPage ID="RadMultiPage1" runat="server">
                        <telerik:RadPageView ID="RadPV_GENERAL" runat="server" Selected="True">
                            <table class="style_table_general">
                                ...
                                <tr>
                                    <td colspan="4">Add this plan to the following assets:</td>
                                    <td>&nbsp;</td>
                                </tr>
                                <tr>
                                    <td colspan="4">
                                        <telerik:RadGrid ID="RadGrid1" runat="server"
                                            DataSourceID="SqlDS_AssetGrid" ResolvedRenderMode="Classic"
                                            AllowPaging="True" Width="150px" Skin="Glow">
                                            <MasterTableView AutoGenerateColumns="False" DataSourceID="SqlDS_AssetGrid"
                                                NoMasterRecordsText="No assets to add to.">
                                                <Columns>
                                                    <telerik:GridBoundColumn DataField="A_Asset_ID"
                                                        FilterControlAltText="Filter A_Asset_ID column" HeaderText="Asset"
                                                        SortExpression="A_Asset_ID" UniqueName="A_Asset_ID">
                                                    </telerik:GridBoundColumn>
                                                    <telerik:GridBoundColumn DataField="A_MOD_ID" DataType="System.Int32"
                                                        Display="False" FilterControlAltText="Filter A_MOD_ID column"
                                                        HeaderText="A_MOD_ID" SortExpression="A_MOD_ID" UniqueName="A_MOD_ID">
                                                    </telerik:GridBoundColumn>
                                                    <telerik:GridBoundColumn DataField="ATT_Name" Display="False"
                                                        FilterControlAltText="Filter ATT_Name column" HeaderText="ATT_Name"
                                ...
                                <tr>
                                    ...
                                    <td style="padding-right: 20px;" align="right">
                                        <telerik:RadButton ID="Btn_Save" runat="server" Skin="Glow"
                                            Text="Add Plan to Assets" Width="150px" BackColor="Red">
                                        </telerik:RadButton>
                                    </td>
                                </tr>
                                <tr>
            ...
            <asp:SqlDataSource ID="SqlDS_Add_Plan" runat="server"
                ConnectionString="<%$ ConnectionStrings:CAMSConnectionString %>"
                SelectCommand="ADMIN_JOB_TRIGGERS_CREATE_SMU_TRIGGER_MONITORING"
                SelectCommandType="StoredProcedure">
                <SelectParameters>
            ...
            <asp:SqlDataSource ID="SqlDS_AssetGrid" runat="server"
                ConnectionString="<%$ ConnectionStrings:CAMSConnectionString %>"
                SelectCommand="SELECT DISTINCT ASSET.A_Asset_ID, ASSET.A_MOD_ID, ATTRIBUTES.ATT_Name FROM SMU_TRIGGER_MONITORING INNER JOIN ASSET ON SMU_TRIGGER_MONITORING.STM_A_ID = ASSET.A_ID INNER JOIN ATTRIBUTES ON ASSET.A_MOD_ID = ATTRIBUTES.ATT_ID WHERE (ASSET.A_MOD_ID = @Model) AND (ASSET.A_Activity_Status &lt;&gt; 'Disposed') AND (ASSET.A_Status NOT IN ('Trash', 'Delete')) ORDER BY ASSET.A_Asset_ID">
                <SelectParameters>
                    <asp:ControlParameter ControlID="lbl_Model_ID" Name="Model" PropertyName="Text" />
                </SelectParameters>
            </asp:SqlDataSource>
